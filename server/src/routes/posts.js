...
router.get('/', async (req, res, next) => {
  try {
    ...
    // For API consistency, if no pagination params are provided, return simple array
...
router.post(
  ...
  async (req, res, next) => {
    try {
      ...
      // Convert to plain object and modify author to show only ID for API consistency
      const responsePost = post.toObject();
      responsePost.author = postData.author;
